...
<body style="min-height: 100%;">
	...
	<header>
		...
		<div class="row">
			...
			<h1 style="margin-top: 10px; border-bottom: 2px solid green; padding:20px 20px 20px 30px;"><strong> <a href="avaliacaoVisaoNBusca.php"> Avaliação Física</a> - Nome do Paciente</strong></h1>
		</div>
